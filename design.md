...
Run all unit tests (using the directory) with logging and compare against expected - to see if output of tests remains the same (except for what is expected)
